...
var ASM_CONSTS = {
  114984: ($0) => { ask_gpt_js(UTF8ToString($0)); },  
 115018: () => { if (document.fullscreenElement) return 1; },  
 115064: () => { return Module.canvas.width; },  
 115096: () => { return parseInt(Module.canvas.style.width); },  
 115144: () => { document.exitFullscreen(); },  
 115171: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 115244: () => { if (document.fullscreenElement) return 1; },  
 115290: () => { return Module.canvas.width; },  
 115322: () => { return screen.width; },  
 115347: () => { document.exitFullscreen(); },  
 115374: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 115507: () => { return window.innerWidth; },  
 115533: () => { return window.innerHeight; },  
 115560: () => { if (document.fullscreenElement) return 1; },  
 115606: () => { return Module.canvas.width; },  
 115638: () => { return parseInt(Module.canvas.style.width); },  
 115686: () => { if (document.fullscreenElement) return 1; },  
 115732: () => { return Module.canvas.width; },  
 115764: () => { return screen.width; },  
 115789: () => { return window.innerWidth; },  
 115815: () => { return window.innerHeight; },  
 115842: () => { if (document.fullscreenElement) return 1; },  
 115888: () => { return Module.canvas.width; },  
 115920: () => { return screen.width; },  
 115945: () => { document.exitFullscreen(); },  
 115972: () => { if (document.fullscreenElement) return 1; },  
 116018: () => { return Module.canvas.width; },  
 116050: () => { return parseInt(Module.canvas.style.width); },  
 116098: () => { document.exitFullscreen(); },  
 116125: ($0) => { Module.canvas.style.opacity = $0; },  
 116163: () => { return screen.width; },  
 116188: () => { return screen.height; },  
 116214: () => { return window.screenX; },  
 116241: () => { return window.screenY; },  
 116268: () => { return window.devicePixelRatio; },  
 116304: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 116357: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 116408: () => { Module.canvas.style.cursor = 'none'; },  
 116445: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 116701: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 116752: () => { if (document.fullscreenElement) return 1; },  
 116798: () => { return window.innerWidth; },  
 116824: () => { return window.innerHeight; },  
 116851: () => { if (document.pointerLockElement) return 1; }
};
